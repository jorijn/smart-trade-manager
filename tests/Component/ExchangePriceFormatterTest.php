...
class ExchangePriceFormatterTest extends TestCase
{
    ...
    public function providerOfRoundTicksCases(): array
    {
        return [
            ...
            ['0.01000000', '0.123456789', '0.12'],
            ['0.00100000', '0.123456789', '0.123'],
            ['0.00010000', '0.123456789', '0.1235'],
            ['0.00001000', '0.123456789', '0.12346'],
            ['0.00000100', '0.123456789', '0.123457'],
            ['0.00000010', '0.123456789', '0.1234568'],
            ['0.00000001', '0.123456789', '0.12345679'],
        ];
    }
